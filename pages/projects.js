...
export default function Projects() {
  return (
    <>
      ...
      <div className="space-y-2 pb-4 pt-6 md:space-y-4">
      ...
      <div className="container py-6">
        <div className="flex flex-wrap">
          <h3 className="mr-8 text-xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-3xl md:leading-14">
            AI and Robotics
          </h3>
